...
with open('./audio set 3 - salam 2/raw data.txt') as f, open('test.wav', 'wb') as fout, open('data.txt', 'wb') as fout2:
    ...
    print(int(data[50], base=16).to_bytes(1, 'big'))
    print(int(data[50], base=16))
    print(binascii.unhexlify(data[50]))
